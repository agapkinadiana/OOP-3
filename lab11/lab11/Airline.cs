...
namespace lab11
{
    public class Airline : IComparable
    {
        ...
        public void ShowDetail() => WriteLine($"Destination: {DESTINATION}, flight: {NUMBEROFFLIGHT}, type: {TYPEOFPLANE}, day: {DAY}");
        ...
        {
            WriteLine($"Number before changing: {num}");
            num = "10";
            WriteLine($"After changing: {num}");
            return num;
        }
